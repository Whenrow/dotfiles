...
-- Personnal Widgets
local battery_widget = require("widget.battery-widget.battery")
...
-- }}}
-- Monitor layout
awful.spawn.with_shell(gears.filesystem.get_configuration_dir() .. "monitor.sh")
...
-- Create Tags (aka Desktop)
local icon_path = function(name)
    return gears.filesystem.get_configuration_dir() .. "icons/".. name .. ".png"
end
local tags = sharedtags({
    { icon = icon_path("thunderbird"), name = "", screen = 1, layout = awful.layout.suit.tile},
    { icon = icon_path("firefox"), name = "", screen = 2, layout = awful.layout.suit.tile},
    { icon = icon_path("discord"),name = "", screen = 2, layout = awful.layout.suit.tile},
    { icon = icon_path("terminal"),name = "", screen = 2, gap=beautiful.useless_gap, layout = awful.layout.suit.tile},
    { icon = icon_path("plus"),name = "", screen = 2, layout = awful.layout.suit.tile},
    { icon = icon_path("plus"),name = "", screen = 2, layout = awful.layout.suit.tile},
    { icon = icon_path("plus"),name = "", screen = 2, layout = awful.layout.suit.tile},
})
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create a taglist widget (desktop)
    ...
    -- Create a tasklist widget (app in the current desktop)
    s.mytasklist = awful.widget.tasklist({
        screen  = s,
        filter  = awful.widget.tasklist.filter.currenttags,
        style = {
            spacing = 10,
            shape_border_width_focus = 13,
            shape_border_color_focus = "#ff0000",
            align = "center",
        },
    })
    ...
    s.mywibox = awful.wibar({
        ...
        border_width = beautiful.useless_gap * 4,
...
globalkeys = gears.table.join(
    awful.key({ modkey,           }, "q",      function()
            logout_popup.launch({
                onlock = function() awful.spawn.with_shell("sh " .. gears.filesystem.get_configuration_dir() .. "bin/lock.sh") end,
                bg_color = beautiful.bg_focus,
                accent_color=beautiful.fg_focus
            })
        end,
    ...
    awful.key({ modkey },            "e",     function () awful.spawn.with_shell('/home/whe/.local/bin/dmenuunicode') end,
